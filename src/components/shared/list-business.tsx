...
export function ListBusiness({ onBusinessListed, asButton = true }: ListBusinessProps) {
    const { user } = useAuth();
    ...
    return (
        <>
            {asButton ? (
                ...
                <Button variant="link" onClick={handleListBusinessClick} className="p-0 h-auto hover:text-primary">
                    List Your Service
                </Button>
            )}
